...
export default function Cadastros() {
  ...
  return (
    <div className="bg-background text-on-background min-h-screen flex antialiased animate-fade-in">
      ...
      {/* Main Content Area */}
      <main className="flex-1 mt-16 p-8 overflow-y-auto md:ml-72 bg-background">
